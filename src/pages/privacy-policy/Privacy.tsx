    ...
    <div className="flex flex-col mt-20">
      ...
      <div className="px-4 py-4 flex md:flex-row flex-col gap-7">
        ...
        <div className=" flex flex-col items-start md:pr-10">
          ...
          <p className="pb-4">
            Your privacy, security, and trust are fundamental to our services. This
            Privacy Policy explains how we collect, use, store, disclose, and protect
            your personal information in accordance with:
          </p>

          <p className="pb-4">• The Privacy Act 1988 (Cth);</p>
          <p className="pb-4">• The Australian Privacy Principles (APPs);</p>
          <p className="pb-4">• The Spam Act 2003 (Cth);</p>
          <p className="pb-4">
            • Applicable Australian consumer protection laws;
          </p>
          <p className="pb-4">
            • International privacy standards where applicable.
          </p>
          <p className="pb-4">
            This Privacy Policy has been developed with consideration of industry practices used by comparable leading platforms, while prioritising stronger transparency, user control, privacy safeguards, and ethical AI-based matchmaking practices.
          </p>
          ...
          <p className="pb-4">
            By accessing or using Wedlock’s website, mobile applications, or services,
            you acknowledge that you have read and understood this Privacy Policy and
            consent to the collection and handling of your information as described
            herein.
          </p>
          <p className="pb-4">
            If you do not agree with this Privacy Policy, you must discontinue use of
            our services.
          </p>

          <p className="text-md font-semibold pb-4">3. Eligibility</p>
          <p className="pb-4">
            Wedlock is strictly intended for adults aged 18 years or older seeking
            genuine matrimonial or long-term relationship opportunities.
          </p>
          <p className="pb-4">
          ...
          <p className="pb-4">• Gender</p>
          <p className="pb-4">• Date of birth</p>
          <p className="pb-4">• Email address</p>
          <p className="pb-4">• Mobile number</p>
          <p className="pb-4">• Location and country</p>
          <p className="pb-4">
            • Community, religion, ethnicity, nationality, or cultural preferences
            (optional)
          </p>
          <p className="pb-4">• Marital status</p>
          <p className="pb-4">• Education and occupation details</p>
          <p className="pb-4">• Lifestyle preferences</p>
          <p className="pb-4">• Relationship preferences</p>
          <p className="pb-4">• Profile photographs</p>

          <p className="text-md font-semibold pb-4">
            4.2 Identity Verification Information
          </p>
          <p className="pb-4">
            To maintain platform authenticity and safety, Wedlock may collect:
          </p>
          <p className="pb-4">• Government-issued identification documents</p>
          <p className="pb-4">• Selfie/photo verification</p>
          <p className="pb-4">• Video verification</p>
          <p className="pb-4">• Mobile verification</p>
          <p className="pb-4">
          ...
          <p className="pb-4">• Create and manage accounts</p>
          <p className="pb-4">• Verify member authenticity</p>
          <p className="pb-4">• Deliver matchmaking services</p>
          <p className="pb-4">• Improve compatibility recommendations</p>
          <p className="pb-4">• Prevent scams and fraudulent activity</p>
          <p className="pb-4">• Moderate content and enforce policies</p>
          <p className="pb-4">• Provide customer support</p>
          <p className="pb-4">• Send transactional notifications</p>
          <p className="pb-4">• Personalise user experience</p>
          <p className="pb-4">
          ...
          <p className="pb-4">
            Wedlock implements industry-standard safeguards including:
          </p>
          <p className="pb-4">• SSL/TLS encryption</p>
          <p className="pb-4">• Encrypted databases</p>
          <p className="pb-4">• Secure authentication systems</p>
          <p className="pb-4">• Access controls</p>
          ...
          <p className="pb-4">• Service delivery</p>
          <p className="pb-4">• Legal obligations</p>
          <p className="pb-4">• Fraud prevention</p>
          <p className="pb-4">• Safety investigations</p>
          <p className="pb-4">• Dispute resolution</p>
          <p className="pb-4">
            Deleted accounts may remain in backups or archived systems for a limited
            period where legally or operationally required.
          </p>
          ...
          <p className="pb-4">• Access personal information</p>
          <p className="pb-4">• Correct inaccurate information</p>
          <p className="pb-4">• Delete account information</p>
          <p className="pb-4">• Withdraw consent</p>
          <p className="pb-4">• Restrict processing</p>
          <p className="pb-4">• Object to certain processing activities</p>
          <p className="pb-4">• Request data portability</p>
          <p className="pb-4">
            Requests may be submitted via our support channels.
          </p>
          <p className="pb-4">
            We aim to respond within reasonable timeframes under Australian privacy law.
          </p>
          ...
          <p className="pb-4">
            Wedlock uses cookies and similar technologies to:
          </p>
          <p className="pb-4">• Maintain login sessions</p>
          <p className="pb-4">• Improve website performance</p>
          <p className="pb-4">• Analyse traffic</p>
          <p className="pb-4">• Personalise experiences</p>
          <p className="pb-4">• Improve security</p>
          <p className="pb-4">• Measure advertising effectiveness</p>
          <p className="pb-4">
          ...
          <p className="pb-4">We may send:</p>
          <p className="pb-4">• Match recommendations</p>
          <p className="pb-4">• Product updates</p>
          <p className="pb-4">• Promotional offers</p>
          <p className="pb-4">• Newsletters</p>
          <p className="pb-4">
            Users can unsubscribe from marketing communications at any time.
          </p>
          <p className="pb-4">
            Transactional or security-related communications may still be sent where
            necessary.
          </p>

          <p className="text-md font-semibold pb-4">
            14. User Safety & Scam Prevention
          </p>
          <p className="pb-4">
            Wedlock actively works to combat:
          </p>
          <p className="pb-4">• Fake profiles</p>
          <p className="pb-4">• Romance scams</p>
          <p className="pb-4">• Identity theft</p>
          <p className="pb-4">• Harassment</p>
          <p className="pb-4">• Spam</p>
          <p className="pb-4">• Malicious activity</p>

          <p className="pb-4">
            Safety measures may include:
          </p>
          <p className="pb-4">• AI moderation</p>
          <p className="pb-4">• Manual review</p>
          <p className="pb-4">• Profile verification</p>
          <p className="pb-4">• Risk scoring</p>
          <p className="pb-4">• Behaviour monitoring</p>
          <p className="pb-4">• Account suspension systems</p>

          <p className="pb-4">
            The online dating industry has faced ongoing criticism relating to fake
            profiles, deceptive subscriptions, privacy concerns, and fraudulent
            behaviour. Wedlock is committed to transparency, ethical practices, and
            user-first safety protections.
          </p>
          ...
          <p className="pb-4">
            Users may request account deletion through account settings or customer
            support.
          </p>
          <p className="pb-4">Upon deletion:</p>
          <p className="pb-4">• Public profile visibility will cease;</p>
          <p className="pb-4">
            • Matches and conversations may be removed or anonymised;
          </p>
          <p className="pb-4">
            • Certain information may be retained temporarily for legal, fraud
            prevention, security, or dispute resolution purposes.
          </p>
          ...
          <p className="pb-4">
            Wedlock may contain links to third-party websites or services.
          </p>
          <p className="pb-4">
          ...
          <p className="pb-4">• Website notices</p>
          <p className="pb-4">• Email notifications</p>
          <p className="pb-4">• In-app notifications</p>
          <p className="pb-4">
            Continued use of Wedlock after updates constitutes acceptance of revised
            terms.
          </p>
          ...
          <p className="pb-4">
            ...
            applicable Commonwealth laws of Australia.
          </p>
        </div>
      </div>
    </div>
