    ...
    <div className="flex flex-col mt-10">
      ...
      <div className="px-4 py-4 flex md:flex-row flex-col gap-7">
        ...
        <div className=" flex flex-col items-start md:pr-10">
          ...
          <p className="pb-4" >
            <span className="font-semibold"> Download the app & take Wedlock.com.au </span> with you. With growing number of success stories, our matchmaking app has transformed the online matrimony category.
          </p>
          ...
          <h3 className="font-bold text-lg  pb-4">Register for free & create a matrimony profile on Wedlock.com.au</h3>
          ...
          <p className="pb-4">Such innovative technology has made Wedlock.com.au as one of the preferred matrimony apps across the world.</p>
