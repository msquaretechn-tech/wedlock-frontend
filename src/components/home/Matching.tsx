...
const Matching = () => {
    ...
    return (
        <div className="bg-[#DCD1E8] bg-gradient-to-bl from-[white] to-[#DCD1E8]     relative w-100   ">
            ...
            <div className="relative overflow-hidden px-5 sm:px-20   container m-auto space-y-2  py-5 md:py-10">
                  ...
                  <div className="space-y-2 ">
                    ...
                    <div className="flex items-center justify-center md:justify-between  gap-2">
                        <button
                            ...
                            className="flex items-center justify-center px-4 text-[#3C2C4C] bg-[white] rounded-full md:w-50 lg:h-[48px] h-10  ">
